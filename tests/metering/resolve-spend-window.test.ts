// Pin host TZ to a non-UTC zone to prove the resolved window is UTC regardless
// of where the process runs. Must run before any import that touches Date.
 ...
 *
 * Behavior:
 *   - Both missing/empty/invalid → default to today as a full UTC day
 *     (00:00 → 23:59:59.999 UTC). Matches the "Today" preset in the date
 *     range picker so URL/UI is identical whether clicked or defaulted, and
 *     lines up with ClickHouse's UTC bucketing.
