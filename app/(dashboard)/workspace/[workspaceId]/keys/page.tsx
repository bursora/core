...
export default async function ApiKeysPage({ params, searchParams }: PageProps) {
    ...
    // Membership is guarded by the parent workspace layout. API keys stay
    // reachable without an active subscription so a lapsed workspace can still
    // rotate or revoke the keys its SDKs authenticate with.
